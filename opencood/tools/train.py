...
def train_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="/home/user/opencood/hypes_yaml/opv2v/pointpillar_mkdcooper.yaml",
...
def main():
    ...
    supervise_single_flag = (
        False
        if not hasattr(opencood_train_dataset, "supervise_single")
    ...
    if run_test:
        ...
        if "noise_setting" in hypes and hypes["noise_setting"]["add_noise"]:
            ...
            cmd = f"python /home/user/opencood/tools/inference.py --model_dir {saved_path} --fusion_method {fusion_method}"
...
"""
ca coalign
CUDA_VISIBLE_DEVICES=2 python opencood/tools/train.py --hypes_yaml opencood/hypes_yaml/back/opv2v/pointpillar_coalign.yaml

CUDA_VISIBLE_DEVICES=2 python opencood/tools/inference.py --model_dir opencood/logs/opv2v_coalian_coib_initial_2026_09_03_17_09_35 --fusion_method intermediate

CUDA_VISIBLE_DEVICES=2 python opencood/tools/train.py --hypes_yaml opencood/hypes_yaml/back/opv2v/pointpillar_coalign_ib.yaml
CUDA_VISIBLE_DEVICES=2 python opencood/tools/train_infocom.py  --fusion_method intermediate --model_dir opencood/logs/
