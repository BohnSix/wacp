...
from opencood.models.fuse_modules.fusion_in_one import MaxFusion, AttFusion, DiscoFusion, V2VNetFusion, V2XViTFusion, When2commFusion, FocalFusion, DattFusion
...
class PointPillarBaselineMultiscale(nn.Module):
    ...
    def __init__(self, args):
        ...
        for i in range(len(args['base_bev_backbone']['layer_nums'])):
            ...
            if args['fusion_method'] == "focalfusion":
                self.fusion_net.append(FocalFusion(args['att']['feat_dim'][i]))
            if args['fusion_method'] == "datt":
                self.fusion_net.append(DattFusion(args['att']['feat_dim'][i]))
    ...
    def forward(self, data_dict):
        ...
        # # single perception
        # spatial_features = spatial_features[0:1]
